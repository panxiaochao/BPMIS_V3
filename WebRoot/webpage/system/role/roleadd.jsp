  ...
  <form method="post" name="submitform" id="submitform">
    <ul class="forminfo" style="padding-left:0;">
      <li>
        ...
        <input name="roleName" type="text" class="dfinput" value=""  style="width:300px;"/>
      </li>
      <li>
        <label>角色编码<b>*</b></label>
        <input name="roleCode" type="text" class="dfinput" value=""  style="width:300px;"/>
      </li>
      <li>
        <label>备注<b>*</b></label>
        <textarea  name="remark" class="dfborder noresize"  style="width:300px;height:150px;"></textarea>
      </li>
    </ul>
  </form>
</div>
