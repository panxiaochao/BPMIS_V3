...
<div class="formbody formborder" >
  <form method="post" name="submitform" id="submitform">
    <ul class="forminfo" style="padding-left:0;">
      <li>
        <label>账号<b>*</b></label>
        <input name="account" type="text" class="dfinput" value=""  style="width:300px;"/>
      </li>
      <li>
        <label>姓名<b>*</b></label>
        <input name="username" type="text" class="dfinput" value=""  style="width:300px;"/>
      </li>
      <li>
        <label>性别<b>*</b></label>
        <label><input name="sex" type="radio" value="0" checked="checked"/> 男
        <input name="sex" type="radio" value="1" /> 女</label>
      </li>
      <li>
        <label>邮箱<b>*</b></label>
        <input name="email" type="text" class="dfinput" value=""  style="width:300px;"/>
      </li>
      <li>
        <label>备注<b>*</b></label>
        <textarea  name="remark" class="dfborder noresize"  style="width:300px;height:100px;"></textarea>
      </li>
    </ul>
  </form>
</div>
