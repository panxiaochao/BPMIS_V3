...
<div class="lefttop"><span></span>${requestScope.pojo.nodename}</div>
<div class="leftmenu">
  <div id="sidebar">
    <div id="sidebar-wrapper"> <!-- Sidebar with logo and menu --> 
      ...
      <ul id="main-nav">
        ...
        <li> <a href="#" class="nav-top-item current"> <!-- Add the class "current" to current menu item --> 
         ${requestScope.pojo.nodename}</a>
          <ul class="navson">
            <li class="nav_active"><cite></cite><a class="current" href="login/index.do" target="rightFrame">首页</a><i></i></li>
            <!-- Add class "current" to sub menu items also -->
            <c:forEach var="var" items="${requestScope.list}" varStatus="st">  
            	<li><cite></cite><a href="${var[1]}" target="rightFrame">${var[2]}</a><i></i></li>            
          	</c:forEach>
          </ul>
        </li>
      </ul>
